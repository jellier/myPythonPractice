...
# timeout参数可以设置超时时间，单位为秒，意思就是如果请求超出了设置的这个时间还没有得到响应，就会抛出异常，如果不指定，就会使用全局默认时间。
...
print(parsed)
# 返回值：ParseResult(scheme='https', netloc='www.zhihu.com',
# path='/question/50056807/answer/223566912', params='', query='',
# fragment='')
